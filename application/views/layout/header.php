...
<head>
  ...
  <!-- Font Awesome -->
  <script src="https://use.fontawesome.com/b21eccb28e.js"></script>
  <!-- Ionicons -->
          ...
          <li class="dropdown user user-menu">
            ...
            <small>Miembro desde <?php echo $this->session->userdata('s_ingreso');?></small>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()?>Cusuarios/verPerfil" class="btn btn-default btn-flat">Ver perfil</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url()?>Clogin/logout" class="btn btn-default btn-flat">Cerrar sesión</a>
                </div>
              </li>
            </ul>
          </li>
